...
<html lang="en">
 <head>
  ...
  <body>
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div class="android-header mdl-layout__header mdl-layout__header--waterfall">
        <div class="mdl-layout__header-row">
          <span class="android-title mdl-layout-title">
            <img class="android-logo-image" src="images/logo-u4-innovation-blanco-.png">
          </span>
          ...
          <!-- Navigation -->
          <div class="android-navigation-container" style="/*background: #A028E6;*/">
            <nav class="android-navigation mdl-navigation">
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Inicio</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="#servicios">Productos/servicios</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Quienes somos</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Testimonios</a>
              <a class="mdl-navigation__link mdl-typography--text-uppercase" href="">Contactos</a>
            </nav>
          </div>
      ...
      <div class="android-content mdl-layout__content">
        ...
        <div class="android-be-together-section mdl-typography--text-center">
          <div class="logo-font android-slogan">Feel free to look around</div>
          <div class="logo-font android-sub-slogan">welcome to u4web... be yourself. do your thing. see what's going on.</div>
        ...
        <div class="android-more-section">
          <div class="android-section-title mdl-typography--display-1-color-contrast" id="servicios">Marketing digital</div>
          <div class="android-card-container mdl-grid">
            <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Servicio 1</h4>
              </div>
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Servicio 2</h4>
              </div>
              <div class="mdl-card__supporting-text">
              ...
              <div class="mdl-card__actions">
                 <a href="https:&#x2F;&#x2F;payment.payphonetodoesposible.com&#x2F;/Pay/1000/6190477d-a58c-4a97-86ce-73cfe61d5962/es/" class="payphone" onmouseover="this.style.backgroundColor='#ff8400'" onmouseout="this.style.backgroundColor='#ff9100'">Pagar $10 con PayPhone</a>
              </div>
            </div>
            ...
            <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
              ...
              <div class="mdl-card__title">
                 <h4 class="mdl-card__title-text">Servicio 3</h4>
              </div>
              <div class="mdl-card__supporting-text">
                <span class="mdl-typography--font-light mdl-typography--subhead">A clean, simple, customisable home screen that comes with the power of Google Now: Traffic alerts, weather and much more, just a swipe away.</span>
              </div>
              <div class="mdl-card__actions">
                <a href="https:&#x2F;&#x2F;payment.payphonetodoesposible.com&#x2F;/Pay/1000/6190477d-a58c-4a97-86ce-73cfe61d5962/es/" class="payphone" onmouseover="this.style.backgroundColor='#ff8400'" onmouseout="this.style.backgroundColor='#ff9100'">Pagar $15 con PayPhone</a>
              </div>
            </div>
            <br>
          </div>
        ...
        <footer class="android-footer mdl-mega-footer">
          ...
          <div class="mdl-mega-footer--middle-section">
            <p class="mdl-typography--font-light">U4 ©Copyright 2017</p>
    ...
    <a href="#servicios" id="view-source" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast">Productos y servicios</a>
